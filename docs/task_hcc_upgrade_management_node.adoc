...
== 将管理节点从12.3.x升级到版本12.5.

您可以将管理节点从12.3.x版原位升级到版本12.5、而无需配置新的管理节点虚拟机。


NOTE: Element 12.5管理节点是一种可选升级。现有部署不需要此功能。

.您需要什么？ #8217 ；将需要什么
* 管理节点 VM 的 RAM 为 24 GB 。
* 您要升级的管理节点为 12.0 版，并使用 IPv4 网络。管理节点版本12.5不支持IPv6。
+
...
* 如果要将管理节点更新到版本12.5、则需要管理服务2.20.69或更高版本才能继续。
