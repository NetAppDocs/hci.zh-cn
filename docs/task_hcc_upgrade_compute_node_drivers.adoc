...
.步骤
. 浏览到 https://mysupport.netapp.com/site/products/all/details/netapp-hci/downloads-tab["NetApp HCI 软件下载"] 页面上，然后单击正确版本的 NetApp HCI 的下载链接。
...
. 单击 * 修复 * ，然后选择新创建的主机基线。确保已选择基线中包含的驱动程序。
