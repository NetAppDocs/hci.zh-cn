...
从管理服务2.2开始、您可以使用NetApp Hybrid Cloud Control UI在管理节点上启用和禁用SSH功能。
...
* *管理服务更新*：
+
** 要使用NetApp Hybrid Cloud Control UI、您已更新 https://mysupport.netapp.com/site/products/all/details/mgmtservices/downloads-tab["管理服务包"^] 到版本2.20。
