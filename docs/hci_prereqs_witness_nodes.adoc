...
如果您要将现有的 Witness 节点就地升级到 Element 12.8 或更高版本，则在升级之前，必须确保 Witness 节点上的 VM 硬件版本与您的环境兼容 ESXi 6.7（VM 硬件版本 14）或更高版本。看link:task_hcc_upgrade_management_node.html#upgrade-vm-hardware["升级VM硬件版本"]。
