...
NOTE: Element 软件 12.9 是最新版本，包含安全性和系统组件更新、操作改进以及已解决的问题。 https://docs.netapp.com/us-en/element-software/concepts/concept_rn_whats_new_element.html["了解 Element 12.9 的新增功能。"^] 。
